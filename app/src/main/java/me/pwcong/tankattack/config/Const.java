...
public class Const {
    ...
    public static final float SIMPLE_ENEMY_SPEED = 6;
    ...
    public static final float SIMPLE_ENEMY_FIRE_SALT = 0.7f;
    public static final float FAST_ENEMY_FIRE_SALT = 0.65f;
    public static final float LARGE_ENEMY_FIRE_SALT = 0.6f;
